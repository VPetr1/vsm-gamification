...
[
  ...
  },
  {
    ...
    "title": "Место у окна",
    "description": "Мужчина занял место девушки у окна, перепутав вагон, а его чемодан перегораживает проход. Синтетический учебный сценарий; опирается на материалы кейса (примеры ситуаций № 8, 13, 14) и не заменяет действующие регламенты.",
    "tags": [
      "communication",
      "safety",
      "stress_resistance",
